...
public class PhotoDownloader {
    ...
    public Observable getPhotoExamples() throws IOException {
    ...
    public Observable<Photo> searchForPhotos(List<String> topics){
        // flatmap
        return Observable.fromIterable(topics)
                .flatMap(query -> searchForPhotos(query)).subscribeOn(Schedulers.io());
    }
