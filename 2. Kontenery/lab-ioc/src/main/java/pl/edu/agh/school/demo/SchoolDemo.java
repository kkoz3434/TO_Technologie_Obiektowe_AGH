...
public class SchoolDemo {
    ...
    public SchoolDemo() {
        ///var persistanceManager = new SerializablePersistenceManager();
        //persistanceManager.setTeachersStorageFileName("teachers2.dat");
        //persistanceManager.setClassStorageFileName("classes2.dat");
        //SchoolDAO schoolDAO = new SchoolDAO(new SerializablePersistenceManager());
